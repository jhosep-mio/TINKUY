...
class productosController extends Controller
{
    ...
    public function index(){
        $productos = productos::join('categorias', 'productos.id_categoria', '=', 'categorias.id')
                             ->join('ciudades', 'productos.id_ciudad', '=', 'ciudades.id')
                            ->select(
                                'productos.*', 
    ...
    public function store(Request $request)
    {
        ...
        $saveproducto->id_ciudad = $request->id_ciudad;
        $saveproducto->nombre = $request->nombre;
        $saveproducto->tiempo = $request->tiempo;
        $saveproducto->precio = $request->precio;
        $saveproducto->min = $request->min;
        $saveproducto->descripcion = $request->descripcion;
        $saveproducto->direccion = $request->direccion;
        $saveproducto->ubicacion = $request->ubicacion;
        $saveproducto->horarios = $request->horarios;
        ...
        if($request->hasFile('imagen1')){
            ...
            $file->move(public_path('actividades/'),$pictureImagen1);
        }  
        ...
        if($request->hasFile('imagen2')){
            ...
            $file->move(public_path('actividades/'),$pictureImagen2);
        }  
        ...
        if($request->hasFile('imagen3')){
            ...
            $file->move(public_path('actividades/'),$pictureImagen3);
        }  
